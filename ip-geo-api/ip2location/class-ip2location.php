...
class IP_Geo_Block_API_IP2Location extends IP_Geo_Block_API {
	...
	public function add_settings_field( $field, $section, $option_slug, $option_name, $options, $callback, $str_path, $str_last ) {
		...
		add_settings_field(
			...
			"$field $str_path (<a rel='noreferrer' href='" . IP_GEO_BLOCK_IP2LOC_IPV4_ZIP . "' title='" . IP_GEO_BLOCK_IP2LOC_IPV4_ZIP . "'>IPv4</a>)",
			$callback,
			$option_slug,
			$section,
			array(
		...
		add_settings_field(
			...
			"$field $str_path (<a rel='noreferrer' href='" . IP_GEO_BLOCK_IP2LOC_IPV6_ZIP . "' title='" . IP_GEO_BLOCK_IP2LOC_IPV6_ZIP . "'>IPv6</a>)",
			$callback,
			$option_slug,
			$section,
			array(
